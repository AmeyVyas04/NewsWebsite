        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-slate-400 mb-6 leading-relaxed">
              Delivering accurate and timely news from around the world. Trusted by millions of readers for unbiased journalism and in-depth reporting.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="bg-slate-800 hover:bg-blue-600 h-10 w-10 rounded-full flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors">World News</a></li>
              ...
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Science</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Finance</a></li>
              ...
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Culture</a></li>
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Opinion</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-slate-400 mb-4">
              Subscribe to our newsletter for daily updates and exclusive content.
            </p>
        ...
        <div className="pt-8 border-t border-slate-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-slate-500 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} Global Herald. All rights reserved.
            </p>
