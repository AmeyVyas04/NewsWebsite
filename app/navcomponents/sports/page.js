            ...
            <div className="min-h-screen bg-gray-50">
                <main className="container mx-auto px-4 py-8">
                    <div className="text-center mb-12">
                        <h1 className="text-4xl font-bold text-gray-800 mb-4">Sports Headlines</h1>
                        <p className="text-gray-600">Latest sports news from India</p>
                    </div>
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-12">
                            <p className="text-gray-600 text-lg">No sports news articles found.</p>
                        </div>
                    ) : (
