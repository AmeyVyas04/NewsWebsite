...
const NewsPage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                setLoading(true)
                const newsData = await Client.topHeadlines({
                    lang: "en",
                    category: "business",
                    country: "in"
                })
          ...
          <div className="min-h-screen bg-gray-50">
            ...
            <main className="container mx-auto px-4 py-8">
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold text-gray-800 mb-4">Business Headlines</h1>
                    <p className="text-gray-600">Latest business news from India</p>
                </div>
